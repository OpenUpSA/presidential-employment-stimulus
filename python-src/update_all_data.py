...
if __name__ == '__main__':
    ...
    parser.add_argument('--phase1_excel', default="input/Copy of Completed Dashboard March 2022 Peter's version KP2 with budgets.xlsx")
    parser.add_argument('--phase2_excel', default='input/Copy of Spreadsheet 2 - To March 2023 2.xlsx')
    parser.add_argument('--phase3_excel', default="input/Worksheet April 2023 - March 2024.xlsx")
