...
export class Header {
  ...
  render() {
    ...
    $el.find('.button-wrap').html('<select><option value="" disabled selected hidden>More about the programme</option><option value="img/PES-Next-Phase.pdf">Next Phase</option></select>');
